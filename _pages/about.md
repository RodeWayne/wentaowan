...
During my Ph.D., my research interests primarily focused on **Visual Understanding, LLM-based Agents, Rigorous Reasoning of LLMs, and Continual Learning** (please refer to my <a href='https://rodewayne.github.io/wentaowan/cv/'>CV</a> for details). My doctoral dissertation, titled **"Research on Enhancing Cognition and Behavior of Large Language Model-based Agents"**, developed methods to bolster the general reasoning and knowledge-updating capacities of LLMs——the cognitive core of agents——and addressed efficient tool learning within non-differentiable agent systems for Visual Reasoning. 
